...
On macOS and Linux, RunSeal reports explicit experimental/community backends. macOS and Linux currently support only explicit `danger-full-access` local execution; sandboxed filesystem and network enforcement remain unsupported until they pass shared conformance gates.
